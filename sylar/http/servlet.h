...
public:
    ...
    using callback = std::function<int32_t (HttpRequest::ptr request, HttpResponse::ptr response, HttpSession::ptr session)>;
...
public:
    ...
    void setDefault(Servlet::ptr v){m_default = v;} //线程安全隐患
