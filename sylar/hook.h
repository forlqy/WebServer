...
//read
typedef ssize_t (*read_fun)(int fildes, void *buf, size_t count);
...
//write
typedef ssize_t (*write_fun)(int fildes, const void *buf, size_t count);
...
#endif
//hook就相当于装饰器模式，调用read函数的时候会调用自己的，而不是系统库的
